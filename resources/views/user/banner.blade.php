                            ...
                            <div class="row align-items-center justify-content-center justify-content-lg-between">
                                ...
                                <div class="col-lg-6 text-center text-lg-start">
                                    <div class="banner-caption cpn tc-light">
                                        ...
                                        <div class="cpn-text">
                                            <p class="lead-s2 animated" data-animate="fadeInUp" data-delay="1.45">{{$data['smalltext']}}</p>
                                        </div>
                                        <div class="cpn-action">
                                            <ul class="cpn-links animated" data-animate="fadeInUp" data-delay="1.55">
                                                <li><a href="{{$data['emailbutton']}}" class="btn btn-md btn-grad">{{$data['button']}}</a></li>
                                                <li><a href="#programs" class="btn btn-md btn-grad">{{$data['secondbutton']}}</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                            <ul class="partner-list-s3 row align-items-center justify-content-center">
                                <li class="col-12 col-md-2 text-center text-md-start">
                                    <h6 class="title title-xs tc-primary mb-md-0 mb-4 animated" data-animate="fadeInUp"
                                        data-delay="1.65">Наши <br> Партнеры</h6>
                                </li>
