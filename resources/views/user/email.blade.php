    ...
    <div class="">
        <div class="card-body p-md-5 p-4 bg-size-cover" style="background-image: url({{asset('/storage/'. $data['image'])}});">
            <div class="py-md-5 py-4 text-center">
                ...
                <p class="fw-normal text-light mt-4 mb-1" style="color: black!important;">{{$data['text']}}</p>
                <a href="mailto:{{$data['email']}}" class="text-light" style="color: black!important;">{{$data['email']}}</a>
            </div>
        </div>
    </div>
</section>
